...
def global_run_settings():
    ...
    modfold = "C:/Users/Jonas/Dropbox/vtraflux_v01_upload/" # choose directory where scripts and inpt data reside & model results are stored 
    
    par_info = {'v_ints': [12 ], 'o_int' : 24,  'v_type' : "variable", 'o_type': "constant",'offset': True, "st_t": 0, 'tpo': "TPO_01"}  


    dat_info = {'sites' : [ "inS6_01"],    'compounds': ["EC"],   'chunk':(1,3),  'depths_T': ["00_20_30"],   'depthpairs_EC': ["00_19"],   'priors': 'bdown_mbhk'}  
    #dat_info = {'sites' : [ "inS6_01"],    'compounds': ["T"],    'chunk':(1,2),  'depths_T': ["00_20_30"],   'depthpairs_EC': ["00_19"],   'priors': 'bdown_mbhk'}     
    #dat_info = {'sites' : [ "inS6_01"],    'compounds': ["EC_T"],   'chunk':(1,2),  'depths_T': ["00_20_30"],   'depthpairs_EC': ["00_19"],   'priors': 'mid'}  
   

    run_info = { 'weights': [0.001,1e-2,0.1,1,10,100,1000,1e4], 'modfold': modfold, 'supercomputer' : False ,
                'vantage' : False,'vantage_w': 10, 'nchains': 28 ,
                'postrun': False, 'Restart': False,  'beta0': 1.0, 'postsim': True,  'strt_opt': "rand"}
    ...
    sim_type = {'lcurve': "joint",  'paramest': "lmfit", 'multicore' : True,   'nprocs': 8,  'method': 'leastsq'   }
    #sim_type = {'lcurve': "single",  'paramest': "lmfit", 'multicore' : True,  'nchains':  32,  'nprocs': 32,  'method': 'leastsq'   }
