...
directory =  os.path.join(secondraft, "inS6","T_inS6_01_1_8_vv03st00_2030_prib")

postpars , ldf= load_text_file(directory,folder = 'T_inS6_01_1_8_vv03st00_2030_prib_w0.0', filename = "postpars.dat", postest = True)
...
plot_ts(directory, folder =  'T_inS6_01_1_8_vv03st00_2030_prib_w0.0', filename =  'T_cmod_all.txt')
plot_ts(directory, folder =  'T_inS6_01_1_8_vv03st00_2030_prib_w0.0', filename =  'T_v_all.txt')
plot_ts(directory, folder =  'T_inS6_01_1_8_vv03st00_2030_prib_w0.0', filename =  'T_d_all.txt')
