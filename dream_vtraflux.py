...
# following Jims Script, DREAM is set up around two classes, DREAM and CHAIN
# The class CHAIN is attached to a DREAM instance 


    
class DREAM:
    def __init__(self, nchains, npars, maxsetback,rac, beta0, boundary, ncr = 3, delta = 3, prior = False, ID = None):
        self.nc = nchains
        self.npars = npars
        self.chains = []
        self.delta = delta 
    ...
    def update_current_temp(self, dirName):
        ...
        for i in range(self.nc):     
            ...
            dds = kappa0 / (n*(pcw) + (1-n)*pcs)  # [L2/T] here m2/h
